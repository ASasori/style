<%-- 
    Document   : manage
    Created on : Jul 2, 2022, 9:19:15 AM
    Author     : Nguyen
--%>
...
<html lang="en">
    <head>
        ...
        <link href="style/css/manager.css" rel="stylesheet" type="text/css" />
        <style>
            img {
                width: 200px;
                height: 120px;
            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <a href="<c:url value="manage/open"/>" class="btn btn-success"
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <c:forEach var="product" items="${products}">
                            <c:url var="updateLink" value="/manage/open">
