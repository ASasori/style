<%-- 
    Document   : shop
    Created on : Jul 2, 2022, 8:35:31 AM
    Author     : Nguyen
--%>
        ...
        <div class="catagories-menu">
            <ul>
                <c:forEach var="category" items="${categories}">
                    <li class="active" ><a href="#"</a>${category.name}</li>
                    <!--  <li><a href="#">Beds</a></li>
                    ...
                    <div class="single-product-wrapper">
                        ...
                        <div
                            ...
                            <div class="ratings-cart text-right">
                                ...
                                <div class="cart">
                                    <a href="cart/add/${product.id}" data-toggle="tooltip" data-placement="left"
                                       title="Add to Cart"><img src="style/img/core-img/cart.png"
                                                             alt=""></a>
                                </div>
                            </div>
                        </div>
